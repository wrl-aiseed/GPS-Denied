...
import sys
sys.path.insert(0, '../..')
from load_file import get_folder_file_pair
...
flight_zone = FlightZone(25.1263315, 121.4875680, 25.1245555, 121.4909780)
...
for i in range(0, height):
    for j in range(0, width):
        ...
        file_path_ = os.path.join(MAP_PATH, photo_name)
        ...
        if r.status_code == 200:
            with open(file_path_, 'wb') as out_file:
